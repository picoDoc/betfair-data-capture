...
q torq.q -load code/processes/discovery.q  -proctype discovery -procname discovery1 -localtime -U config/passwords/accesslist.txt 1 </dev/null >$KDBLOG/torqdiscovery.txt 2>&1 &
...
q torq.q -load code/processes/housekeeping.q -proctype housekeeping -procname housekeeping1 -localtime -U config/passwords/accesslist.txt 1 </dev/null >$KDBLOG/torqhousekeeping.txt 2>&1 &
...
# launch wdb
echo 'Starting wdb...'
q torq.q -load code/processes/wdb.q -proctype wdb -procname wdb1 -localtime -U config/passwords/accesslist.txt 1 -g 1 -.proc.loadprocesscode 1 </dev/null >$KDBLOG/torqwdb.txt 2>&1 &  # pdb process

# launch compress
echo 'Starting compression proc...'
q torq.q -load code/processes/compression.q  -proctype compression -procname compression1 -localtime 1 </dev/null >$KDBLOG/torqcompress1.txt 2>&1 &  # compression process
