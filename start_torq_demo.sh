...
# launch wdb
echo 'Starting wdb...'
q torq.q -load code/processes/wdb.q -localtime -p 31400 -U config/passwords/accesslist.txt 1 -g 1 -.proc.loadprocesscode 1 </dev/null >$KDBLOG/torqwdb.txt 2>&1 &  # pdb process
